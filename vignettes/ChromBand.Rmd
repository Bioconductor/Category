...
For illustration, we use a microarray dataset [@Chiaretti2005] from a clinical trial in acute lymphoblastic leukemia (ALL). The data are described in Chapter 2 of [@BiocCaseStudies]. For the
...
```{r echo = FALSE, tidy=FALSE, results = 'asis'}
columns <- c(" ", " ChrMapID ", "   Pvalue ", " OddsRatio ", " ExpCount ", "  Count ", "   Size ")
chrombands_data <- read_excel(path = "chrombands_data.xlsx", sheet = "data1", skip = 1, col_names = columns)
kable(chrombands_data[1:25, ], caption = "Hypergeometric Testing Table", align = "r")
```
:::
...
```{r echo = FALSE, tidy=FALSE, results = 'asis'}
columns <- c(" ", " ChrMapID ", "   Pvalue ", " OddsRatio ", " ExpCount ", "  Count ", "   Size ")
chrombands_data <- read_excel(path = "chrombands_data.xlsx", sheet = "data2", skip = 1, col_names = columns)
kable(chrombands_data[1:20, ], caption = "Hypergeometric Testing Table", align = "r")
```
:::
:::
...
\+ panel.stripplot(\...) + panel.average(\..., fun = mean, lwd = 3) +  })
:::
:::
...
::: center
```{r gseaStripplot, echo=FALSE, fig.align="center", out.width="100%", out.height="100%"}
knitr::include_graphics("figures/gseaStripplot.png")
```
:::
...
\> [params\@graph](mailto:params@graph){.email} \<- makeChrBandGraph([params\@annotation](mailto:params@annotation){.email}, [params\@universeGeneIds](mailto:params@universeGeneIds){.email})

\> [params\@gsc](mailto:params@gsc){.email} \<- makeChrBandGSC([params\@graph](mailto:params@graph){.email})

\> paramsCond \<- params

\> [paramsCond\@conditional](mailto:paramsCond@conditional){.email} \<- TRUE
:::
:::
...
::: Soutput
```{r echo = FALSE, tidy=FALSE, results = 'asis'}
columns <- c(" ", " ChrMapID ", " Pvalue ", " Effect ", " Size ", "  Conditional ", "   TestDirection ")
chrombands_data <- read_excel(path = "chrombands_data.xlsx", sheet = "data3", skip = 1, col_names = columns)
kable(chrombands_data[1:51, ], caption = "GSEA Using Linear Model", align = "r")
```
:::
...
```{r echo = FALSE, tidy=FALSE, results = 'asis'}
columns <- c(" ", " ChrMapID ", " Pvalue ", " Effect ", " Size ", "  Conditional ", "   TestDirection ")
chrombands_data <- read_excel(path = "chrombands_data.xlsx", sheet = "data4", skip = 1, col_names = columns)
kable(chrombands_data[1:27, ], caption = "GSEA Using Linear Model", align = "r")
```
:::
...
::: center
```{r dotplot1p362, echo=FALSE, fig.align="center", out.width="100%", out.height="100%"}
knitr::include_graphics("figures/dotplot1p362.png")
```
:::
